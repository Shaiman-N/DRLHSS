...
void testSandboxInitialization() {
    std::cout << "[TEST] Testing macOS Sandbox Initialization...\n";
    
    sandbox::MacOSSandbox sandbox(sandbox::SandboxType::POSITIVE_FP);
    
    sandbox::SandboxConfig config;
    config.sandbox_id = "test_macos_001";
...
void testSandboxExecution() {
    std::cout << "[TEST] Testing macOS Sandbox Execution...\n";
    
    sandbox::MacOSSandbox sandbox(sandbox::SandboxType::POSITIVE_FP);
    
    sandbox::SandboxConfig config;
    config.sandbox_id = "test_macos_002";
    config.memory_limit_mb = 256;
    config.cpu_limit_percent = 50;
    config.timeout_seconds = 10;
...
void testSandboxPacketAnalysis() {
    std::cout << "[TEST] Testing macOS Sandbox Packet Analysis...\n";
    
    sandbox::MacOSSandbox sandbox(sandbox::SandboxType::POSITIVE_FP);
    
    sandbox::SandboxConfig config;
    config.sandbox_id = "test_macos_003";
    config.memory_limit_mb = 256;
    config.cpu_limit_percent = 50;
    config.timeout_seconds = 10;
...
void testSandboxReset() {
    std::cout << "[TEST] Testing macOS Sandbox Reset...\n";
    
    sandbox::MacOSSandbox sandbox(sandbox::SandboxType::POSITIVE_FP);
    
    sandbox::SandboxConfig config;
    config.sandbox_id = "test_macos_004";
    config.memory_limit_mb = 256;
    config.cpu_limit_percent = 50;
    config.timeout_seconds = 10;
...
int main() {
    std::cout << "========================================\n";
    std::cout << "  macOS Sandbox Test Suite\n";
    std::cout << "========================================\n\n";
